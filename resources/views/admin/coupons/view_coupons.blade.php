            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">@if($coupon->amount_type=="Fixed")${{ $coupon->amount }}@else {{ $coupon->amount }} %@endif</td>
                  ...
                  <td class="center"> 
                    ...
                    <a id="delCoupon" rel="{{ $coupon->id }}" rel1="delete-coupon" href="{{ url('/admin/delete-coupon/'.$coupon->id) }}" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
